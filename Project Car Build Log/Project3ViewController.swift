...
class Project3ViewController: UIViewController {
    ...
    @IBOutlet weak var P3BannerView: GADBannerView!
    ...
    override func viewDidLoad() {
        ...
        setupConstraints()
        PartInfo = general.readFile(fileName: "file3.txt")
        ...
        setup()
        if general.getPro() {
            P3BannerView.isHidden = true
        } else {
            self.P3BannerView.adUnitID = general.getGADUnitID(storyboard: "Project")
            self.P3BannerView.rootViewController = self
            P3BannerView.load(GADRequest())
        }
    }
    ...
    func setupConstraints() {
        ...
        if general.getPro() {
            ...
            P3BannerView.center.x = centerX
            P3BannerView.center.y = view.frame.maxY - 50
            Version.center.y = P3BannerView.center.y - 35
        }
        ...
        self.view.bringSubviewToFront(P3BannerView)
    ...
    func writeNewStuff(partNum: Int, partName: String, partCost: String, partDate: String, doIExist: String, edit: Bool) {
        ...
        general.reorganizeParts(project: 3, partRemoved: partNum)
        setupConstraints()
        setup()
    }
